...
NR_ISBN NUMBER (8) NOT NULL CONSTRAINT PK_CPK_LIVRO PRIMARY KEY,
CD_CATEGORIA NUMBER(3) NOT NULL,
NM_TITULO VARCHAR2(50) NOT NULL,
DS_SINOPSE VARCHAR2(200) NOT NULL,
NR_EDICAO NUMBER(2) NOT NULL,
NR_ANO NUMBER(4),
CONSTRAINT FK_CKP_LIVRO_CATEGORIA FOREIGN KEY (CD_CATEGORIA) REFERENCES T_CKP_CATEGORIA(CD_CATEGORIA)
);

CREATE TABLE T_CPK_AUTOR_LIVRO (
...
ALTER TABLE T_CKP_AUTOR_LIVRO ADD CONSTRAINT PK_CKP_AUTOR_LIVRO FOREIGN KEY (NR_ISBN);
REFERENCES T_CKP_LIVRO (NR_ISBN);

CREATE TABLE T_CKP_AUTOR(
CD_AUTOR NUMBER(3) NOT NULL,
NM_PRIMEIRO_AUTOR VARCHAR2(30) NOT NULL,
NM_SEGUNDO_AUTOR VARCHAR2(40) NOT NULL
);
ALTER TABLE T_CKP_AUTOR ADD CONSTRAINT PK_CKP__AUTOR PRIMARY KEY(CD_AUTOR);

ALTER TABLE T_CKP_AUTOR_LIVRO ADD CONSTRAINT FK_CKP_AUTOR_LIVRO_AUTOR FOREIGN KEY(CD_AUTOR)
REFERENCES T_CKP_AUTOR (CD_AUTOR);

ALTER TABLE T_CKP_AUTOR_LIVRO ADD CONSTRAINT CK_CKP_AUTOR_LIVRO_STATUS
